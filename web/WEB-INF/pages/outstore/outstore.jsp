...
<script src="${pageContext.request.contextPath}/js/outstore.js"></script>
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/outstore.css"/>
